...
if (mysqli_num_rows($result) > 0) {
    ...
    $query = "INSERT INTO sign_up (first, last, D.O.B, username, email, local_address, city, mobile, password) VALUES ('$first', '$last', '$date', '$username', '$email', '$local_address', '$city', '$mobile', '$password')";
